...
export const addFavorite = createAsyncThunk(
  ...
  async (recipeId, thunkAPI) => {
    try {
      ...
      return thunkAPI.rejectWithValue(error.response?.data || { message: 'Failed to like recipe' });
    }
  }
);
...
export const removeFavorite = createAsyncThunk(
  ...
  async (recipeId, thunkAPI) => {
    try {
      ...
      return thunkAPI.rejectWithValue(error.response?.data || { message: 'Failed to unlike recipe' });
    }
  }
);
